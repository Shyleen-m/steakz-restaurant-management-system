-- CreateEnum
CREATE TYPE "Role" AS ENUM ('HEADQUARTERS_MANAGER', 'BRANCH_MANAGER', 'ADMIN', 'WAITER', 'INVENTORY_MANAGER');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PREPARING', 'READY', 'COMPLETED', 'PAID', 'CANCELLED');
